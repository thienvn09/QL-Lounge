...
INSERT [dbo].[category] ([id], [title], [content], [createAt], [updateat]) VALUES (1, N'Táo', N'Cung cấp tất cả các loại táo tươi ngon, giàu dinh dưỡng.', CAST(N'2024-07-24T14:33:29.983' AS DateTime), CAST(N'2024-07-24T14:33:29.983' AS DateTime))
INSERT [dbo].[category] ([id], [title], [content], [createAt], [updateat]) VALUES (2, N'Chuối', N'Tự hào là một trong những đơn vị hàng đầu trong lĩnh vực cung cấp chuối tươi ngon, giàu dinh dưỡng.', CAST(N'2024-07-24T14:33:29.983' AS DateTime), CAST(N'2024-07-24T14:33:29.983' AS DateTime))
INSERT [dbo].[category] ([id], [title], [content], [createAt], [updateat]) VALUES (3, N'Cam', N'Chuyên cung cấp các loại cam tươi ngon, giàu vitamin C.', CAST(N'2024-07-24T14:33:29.983' AS DateTime), CAST(N'2024-07-24T14:33:29.983' AS DateTime))
INSERT [dbo].[category] ([id], [title], [content], [createAt], [updateat]) VALUES (4, N'Xoài', N'Khi mua một quả xoài, chắc hẳn bạn sẽ phải tìm hiểu rất kỹ mới có thể đưa ra quyết định, vì chất lượng và hương vị rất quan trọng.', CAST(N'2024-07-24T14:33:29.983' AS DateTime), CAST(N'2024-07-24T14:33:29.983' AS DateTime))
INSERT [dbo].[category] ([id], [title], [content], [createAt], [updateat]) VALUES (5, N'Dứa', N'Cung cấp nhiều loại dứa tươi ngon, giàu dinh dưỡng.', CAST(N'2024-07-24T14:33:29.983' AS DateTime), CAST(N'2024-07-24T14:33:29.983' AS DateTime))
INSERT [dbo].[category] ([id], [title], [content], [createAt], [updateat]) VALUES (6, N'Nho', N'Nếu bạn đang tìm kiếm những chùm nho tươi ngon, giàu dinh dưỡng, hãy tham khảo ngay các loại nho tại cửa hàng của chúng tôi.', CAST(N'2024-07-24T14:33:29.983' AS DateTime), CAST(N'2024-07-24T14:33:29.983' AS DateTime))
...
-- Các mục menu cấp con (thay đổi các mục công nghệ thành trái cây)
INSERT [dbo].[menu] ([id], [parentId], [title], [menuUrl], [menuIndex], [isVisible]) VALUES (4, 3, N'Táo', N'/Product?idcategory=1', 4, 1)
INSERT [dbo].[menu] ([id], [parentId], [title], [menuUrl], [menuIndex], [isVisible]) VALUES (5, 3, N'Dâu tây', N'/Product?idcategory=2', 5, 1)
INSERT [dbo].[menu] ([id], [parentId], [title], [menuUrl], [menuIndex], [isVisible]) VALUES (6, 3, N'Dưa hấu', N'/Product?idcategory=3', 6, 1)
INSERT [dbo].[menu] ([id], [parentId], [title], [menuUrl], [menuIndex], [isVisible]) VALUES (7, 3, N'Chuối', N'/Product?idcategory=4', 7, 1)
INSERT [dbo].[menu] ([id], [parentId], [title], [menuUrl], [menuIndex], [isVisible]) VALUES (8, 3, N'Dứa', N'/Product?idcategory=5', 8, 1)
...
UPDATE [dbo].[category] SET [title] = N'Táo', [content] = N'Cung cấp tất cả các loại táo tươi ngon, giàu dinh dưỡng.', [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), [updateat] = CAST(N'2024-07-24T14:33:29.983' AS DateTime) WHERE [id] = 1
UPDATE [dbo].[category] SET [title] = N'Chuối', [content] = N'Tự hào là một trong những đơn vị hàng đầu trong lĩnh vực cung cấp chuối tươi ngon, giàu dinh dưỡng.', [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), [updateat] = CAST(N'2024-07-24T14:33:29.983' AS DateTime) WHERE [id] = 2
UPDATE [dbo].[category] SET [title] = N'Cam', [content] = N'Chuyên cung cấp các loại cam tươi ngon, giàu vitamin C.', [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), [updateat] = CAST(N'2024-07-24T14:33:29.983' AS DateTime) WHERE [id] = 3
UPDATE [dbo].[category] SET [title] = N'Xoài', [content] = N'Khi mua một quả xoài, chắc hẳn bạn sẽ phải tìm hiểu rất kỹ mới có thể đưa ra quyết định, vì chất lượng và hương vị rất quan trọng.', [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), [updateat] = CAST(N'2024-07-24T14:33:29.983' AS DateTime) WHERE [id] = 4
UPDATE [dbo].[category] SET [title] = N'Dứa', [content] = N'Cung cấp nhiều loại dứa tươi ngon, giàu dinh dưỡng.', [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), [updateat] = CAST(N'2024-07-24T14:33:29.983' AS DateTime) WHERE [id] = 5
UPDATE [dbo].[category] SET [title] = N'Nho', [content] = N'Nếu bạn đang tìm kiếm những chùm nho tươi ngon, giàu dinh dưỡng, hãy tham khảo ngay các loại nho tại cửa hàng của chúng tôi.', [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), [updateat] = CAST(N'2024-07-24T14:33:29.983' AS DateTime) WHERE [id] = 6

SET IDENTITY_INSERT [dbo].[category] OFF
GO
UPDATE [dbo].[product] SET 
    [title] = N'Táo Fuji', 
    [content] = N'Táo Fuji tươi ngon, giòn ngọt, giàu dinh dưỡng.', 
    [img] = 'Tao.jpg', 
    [price] = 50000, 
    [rate] = 4.5, 
    [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), 
    [updateAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), 
    [categoryId] = 1 
WHERE [id] = 1;

UPDATE [dbo].[product] SET 
    [title] = N'Chuối Laba', 
    [content] = N'Chuối Laba tươi ngon, giàu dinh dưỡng.', 
    [img] = 'chuoi.jpg', 
    [price] = 30000, 
    [rate] = 4.7, 
    [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), 
...
UPDATE [dbo].[product] SET 
    [title] = N'Cam Sành', 
    [content] = N'Cam Sành tươi ngon, giàu vitamin C.', 
...
UPDATE [dbo].[product] SET 
    [title] = N'Xoài Cát Hòa Lộc', 
    [content] = N'Xoài Cát Hòa Lộc tươi ngon, hương vị đậm đà.', 
    [img] = 'default-image.png', 
    [price] = 60000, 
    [rate] = 4.8, 
    [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), 
...
UPDATE [dbo].[product] SET 
    [title] = N'Dứa Queen', 
    [content] = N'Dứa Queen tươi ngon, giàu dinh dưỡng.', 
    [img] = 'default-image.png', 
    [price] = 35000, 
    [rate] = 4.4, 
    [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), 
...
UPDATE [dbo].[product] SET 
    [title] = N'Nho Mỹ', 
    [content] = N'Nho Mỹ tươi ngon, giàu dinh dưỡng.', 
    [img] = N'path/to/image6.jpg', 
    [price] = 70000, 
    [rate] = 4.9, 
    [createAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), 
    [updateAt] = CAST(N'2024-07-24T14:33:29.983' AS DateTime), 
