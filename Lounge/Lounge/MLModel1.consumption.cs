...
namespace Lounge
{
    public partial class MLModel1
    {
        ...
        {
            [ColumnName(@"Filename")]
            public float[] Filename { get; set; }

            [ColumnName(@"Predicted Label")]
            public float[] Predicted_Label { get; set; }

            [ColumnName(@"Ground Truth")]
            public uint Ground_Truth { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Ground Truth");
            if (labelColumn == null)
            {
                throw new Exception("Ground Truth column not found. Make sure the name searched for matches the name in the schema.");
            }
