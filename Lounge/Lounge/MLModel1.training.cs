...
namespace Lounge
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\THIEN\Desktop\python\BaiTapLon_NLMH\test_results_20250530_162845.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Predicted Label", @"Predicted Label", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Filename",outputColumnName:@"Filename"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Predicted Label",@"Filename"}))      
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Ground Truth",inputColumnName:@"Ground Truth",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.09999999999999998,LabelColumnName=@"Ground Truth",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"Ground Truth"))      
